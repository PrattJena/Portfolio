  ...
  return (
    <div className='h-full w-full'>
      ...
      <div className='flex h-[10%] w-full flex-col md:flex-row md:items-end md:justify-between'>
        <div className='text-p xl:text-span text-center font-[Aeonik] font-semibold tracking-tight text-[#F3F2F2] md:text-left'>
          © Pratyush Jena 2025
        </div>
        <div className='text-p lg:text-span text-center font-[Aeonik] font-semibold tracking-tight text-[#F3F2F2] md:text-right'>
